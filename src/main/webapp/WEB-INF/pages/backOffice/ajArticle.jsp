...
<head>
  <title>IA content &mdash; ajout article</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="description" content="creer article">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <form method="post" action="<%=request.getContextPath()%>/createArticle" enctype="multipart/form-data">

            <div class="row">
              <div class="col-md-6 form-group">
                <label for="fname">titre</label>
                <input type="text" id="fname" class="form-control form-control-lg" name="titre" required>
              </div>
              <div class="col-md-6 form-group">
            ...
            <div class="row">
              <div class="col-md-12 form-group">
                <label for="containerEditor">CK EDITOR</label>
                <div id="containerEditor">

                  <textarea id="editor" name="descri" required>
                  </textarea>
                </div>
              </div>
            </div>
